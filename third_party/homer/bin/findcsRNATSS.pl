...
sub printCMD {
	print STDERR "\n\tThis program is a legacy placeholder - please use findcsRNATSR.pl instead\n\n";
	...
	print STDERR "\n\t\tRegion sizes:\n";
	print STDERR "\t\t-size <#> (size of regions to check for significant TSS clusters, default: $tssSize)\n";
	print STDERR "\t\t-minDist <#> (minimum distance between adjacent TSS clusters, default: $minDist)\n";
...
$findPeaksTSSoptions .= " -L $localFold -size $tssSize -ntagThreshold $tagThreshold $minDist ";
