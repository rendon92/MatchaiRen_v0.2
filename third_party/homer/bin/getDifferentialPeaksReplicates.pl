...
sub printCMD {
	...
	print STDERR "\t\t-style <factor|histone|tsr> (findPeaks style to use for finding peaks)\n";
	print STDERR "\t\t-use <peaks.txt|regions.txt|tsr.txt> (use existing peaks in tag directories)\n";
